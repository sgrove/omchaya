...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_15771 = 0;while(true){
if((i_15771 < arr.length))
{(arr[i_15771] = null);
{
var G__15772 = (i_15771 + 1);
i_15771 = G__15772;
continue;
}
} else
...
{var i_15778 = (self__.level + 1);while(true){
if((i_15778 <= (new_level + 1)))
{(update[i_15778] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15780 = 0;while(true){
if((i_15780 <= self__.level))
{var links_15781 = (update[i_15780]).forward;if(((links_15781[i_15780]) === x__$1))
{(links_15781[i_15780] = (x__$1.forward[i_15780]));
{
