...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15812 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15812 = (function (val,box,meta15813){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15812.cljs$lang$type = true;
cljs.core.async.impl.channels.t15812.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15812";
cljs.core.async.impl.channels.t15812.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t15812");
});
cljs.core.async.impl.channels.t15812.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15812.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15814){var self__ = this;
var _15814__$1 = this;return self__.meta15813;
});
cljs.core.async.impl.channels.t15812.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15814,meta15813__$1){var self__ = this;
var _15814__$1 = this;return (new cljs.core.async.impl.channels.t15812(self__.val,self__.box,meta15813__$1));
});
cljs.core.async.impl.channels.__GT_t15812 = (function __GT_t15812(val__$1,box__$1,meta15813){return (new cljs.core.async.impl.channels.t15812(val__$1,box__$1,meta15813));
});
}
return (new cljs.core.async.impl.channels.t15812(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_15815 = self__.takes.pop();if((taker_15815 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15815))
{var take_cb_15816 = cljs.core.async.impl.protocols.commit.call(null,taker_15815);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15816,taker_15815){
return (function (){return take_cb_15816.call(null,null);
});})(take_cb_15816,taker_15815))
);
} else
{}
{
