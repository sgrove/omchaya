...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15806 = 0;while(true){
var m_15807 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15807 == null))
{} else
{m_15807.call(null);
if((count_15806 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15808 = (count_15806 + 1);
count_15806 = G__15808;
continue;
}
} else
{}
