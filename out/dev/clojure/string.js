...
{{
var G__15983 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15983;
continue;
}
} else
...
{var pred__15987 = cljs.core._EQ_;var expr__15988 = limit;if(cljs.core.truth_(pred__15987.call(null,1,expr__15988)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15987.call(null,2,expr__15988)))
...
var G__15990 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15991 = (limit__$1 - 1);
var G__15992 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15990;
limit__$1 = G__15991;
parts = G__15992;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___15994 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___15994))
{var replacement_15995 = temp__4090__auto___15994;buffer.append([cljs.core.str(replacement_15995)].join(''));
} else
{buffer.append(ch);
}
{
var G__15996 = (index + 1);
index = G__15996;
continue;
}
}
