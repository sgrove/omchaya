...
cljs.core._add_method.call(null,omchaya.commands.handle_maybe_command,"/play",(function (target,activity,state){var controls_ch = cljs.core.get_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"comms","comms",1108747865),new cljs.core.Keyword(null,"controls","controls",4741937704)], null));var temp__4092__auto___10650 = (function (){var or__3403__auto__ = (function (){var G__10649 = new cljs.core.Keyword(null,"content","content",1965434859).cljs$core$IFn$_invoke$arity$1(activity);var G__10649__$1 = (((G__10649 == null))?null:clojure.string.split.call(null,G__10649,/ /));var G__10649__$2 = (((G__10649__$1 == null))?null:cljs.core.second.call(null,G__10649__$1));var G__10649__$3 = (((G__10649__$2 == null))?null:cljs.core.first.call(null,cljs.core.re_find.call(null,/http.*\.(mp3|mp4|ogg|wav)/,G__10649__$2)));return G__10649__$3;
...
})();if(cljs.core.truth_(temp__4092__auto___10650))
{var url_10651 = temp__4092__auto___10650;cljs.core.async.put_BANG_.call(null,controls_ch,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"audio-player-source-updated","audio-player-source-updated",2679762480),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [url_10651,new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411).cljs$core$IFn$_invoke$arity$1(state)], null)], null));
} else
{}
