...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_26105 = 0;while(true){
var m_26106 = cljs.core.async.impl.dispatch.tasks.pop();if((m_26106 == null))
{} else
{(m_26106.cljs$core$IFn$_invoke$arity$0 ? m_26106.cljs$core$IFn$_invoke$arity$0() : m_26106.call(null));
if((count_26105 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__26107 = (count_26105 + 1);
count_26105 = G__26107;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3391__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3391__auto__)
