...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write(writer__3971__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_26070 = 0;while(true){
if((i_26070 < arr.length))
{(arr[i_26070] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write(writer__3971__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_26077 = (self__.level + 1);while(true){
if((i_26077 <= (new_level + 1)))
{(update[i_26077] = self__.header);
{
var G__26078 = (i_26077 + 1);
i_26077 = G__26078;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26079 = 0;while(true){
if((i_26079 <= self__.level))
{var links_26080 = (update[i_26079]).forward;if(((links_26080[i_26079]) === x__$1))
{(links_26080[i_26079] = (x__$1.forward[i_26079]));
{
var G__26081 = (i_26079 + 1);
i_26079 = G__26081;
continue;
}
} else
{{
var G__26082 = (i_26079 + 1);
i_26079 = G__26082;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3403__auto__ = (cljs.core.truth_((function (){var and__3391__auto__ = me;if(cljs.core.truth_(and__3391__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3391__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3403__auto__))
