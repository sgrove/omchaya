...
return random_message__delegate.call(this,channel_id,p__10744);};
random_message.cljs$lang$maxFixedArity = 1;
random_message.cljs$lang$applyTo = (function (arglist__10747){
var channel_id = cljs.core.first(arglist__10747);
var p__10744 = cljs.core.rest(arglist__10747);
return random_message__delegate(channel_id,p__10744);
});
random_message.cljs$core$IFn$_invoke$arity$variadic = random_message__delegate;
return random_message;
})()
;
omchaya.mock_data.random_title = (function random_title(){return cljs.core.rand_nth.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Background","A dark place","\uD55C\uAD6D\uC5B4","Zork lovers","The War Room"], null));
});
...
var random_channel__delegate = function (order,p__10748){var vec__10750 = p__10748;var title = cljs.core.nth.call(null,vec__10750,0,null);var title__$1 = (function (){var or__3403__auto__ = title;if(cljs.core.truth_(or__3403__auto__))
...
var p__10748 = null;if (arguments.length > 1) {
  p__10748 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return random_channel__delegate.call(this,order,p__10748);};
random_channel.cljs$lang$maxFixedArity = 1;
random_channel.cljs$lang$applyTo = (function (arglist__10751){
var order = cljs.core.first(arglist__10751);
var p__10748 = cljs.core.rest(arglist__10751);
return random_channel__delegate(order,p__10748);
});
random_channel.cljs$core$IFn$_invoke$arity$variadic = random_channel__delegate;
return random_channel;
})()
;
omchaya.mock_data.initial_state = (function initial_state(comms){var channels = (function (){var ch = cljs.core.map.call(null,cljs.core.comp.call(null,cljs.core.juxt.call(null,new cljs.core.Keyword(null,"id","id",1013907597),cljs.core.identity),omchaya.mock_data.random_channel),cljs.core.range.call(null,2,8));var ch__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,ch);return ch__$1;
})();return new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"audio","audio",1107070792),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"volume","volume",4497988236),100,new cljs.core.Keyword(null,"muted","muted",1118168285),true], null),new cljs.core.Keyword(null,"settings","settings",2448535445),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message-limit","message-limit",2656236007),50,new cljs.core.Keyword(null,"forms","forms",1111523233),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"search","search",4402534682),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"focused","focused",4617830121),false], null),new cljs.core.Keyword(null,"user-message","user-message",2253309815),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"focused","focused",4617830121),false], null)], null),new cljs.core.Keyword(null,"menus","menus",1117686374),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"user-menu","user-menu",1307043219),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"open","open",1017321916),false], null)], null)], null),new cljs.core.Keyword(null,"selected-channel","selected-channel",2473753411),"lobby",new cljs.core.Keyword(null,"channels","channels",2446530370),(function (){var ch = channels;var ch__$1 = cljs.core.assoc.call(null,ch,"lobby",omchaya.mock_data.random_channel.call(null,1,"Lobby"));var ch__$2 = cljs.core.update_in.call(null,ch__$1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["lobby"], null),cljs.core.assoc,new cljs.core.Keyword(null,"selected","selected",2205476365),true);return ch__$2;
