...
{{
var G__14610 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14610;
continue;
}
} else
...
{var pred__14614 = cljs.core._EQ_;var expr__14615 = limit;if(cljs.core.truth_(pred__14614.call(null,1,expr__14615)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14614.call(null,2,expr__14615)))
...
var G__14617 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14618 = (limit__$1 - 1);
var G__14619 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14617;
limit__$1 = G__14618;
parts = G__14619;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14621 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14621))
{var replacement_14622 = temp__4090__auto___14621;buffer.append([cljs.core.str(replacement_14622)].join(''));
} else
{buffer.append(ch);
}
{
var G__14623 = (index + 1);
index = G__14623;
continue;
}
}
