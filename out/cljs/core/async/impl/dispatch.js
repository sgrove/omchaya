...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14433 = 0;while(true){
var m_14434 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14434 == null))
{} else
{m_14434.call(null);
if((count_14433 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14435 = (count_14433 + 1);
count_14433 = G__14435;
continue;
}
} else
{}
