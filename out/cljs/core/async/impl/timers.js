...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14398 = 0;while(true){
if((i_14398 < arr.length))
{(arr[i_14398] = null);
{
var G__14399 = (i_14398 + 1);
i_14398 = G__14399;
continue;
}
} else
...
{var i_14405 = (self__.level + 1);while(true){
if((i_14405 <= (new_level + 1)))
{(update[i_14405] = self__.header);
{
var G__14406 = (i_14405 + 1);
i_14405 = G__14406;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14407 = 0;while(true){
if((i_14407 <= self__.level))
{var links_14408 = (update[i_14407]).forward;if(((links_14408[i_14407]) === x__$1))
{(links_14408[i_14407] = (x__$1.forward[i_14407]));
{
