...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14439 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14439 = (function (val,box,meta14440){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14439.cljs$lang$type = true;
cljs.core.async.impl.channels.t14439.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14439";
cljs.core.async.impl.channels.t14439.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t14439");
});
cljs.core.async.impl.channels.t14439.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14439.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14441){var self__ = this;
var _14441__$1 = this;return self__.meta14440;
});
cljs.core.async.impl.channels.t14439.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14441,meta14440__$1){var self__ = this;
var _14441__$1 = this;return (new cljs.core.async.impl.channels.t14439(self__.val,self__.box,meta14440__$1));
});
cljs.core.async.impl.channels.__GT_t14439 = (function __GT_t14439(val__$1,box__$1,meta14440){return (new cljs.core.async.impl.channels.t14439(val__$1,box__$1,meta14440));
});
}
return (new cljs.core.async.impl.channels.t14439(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14442 = self__.takes.pop();if((taker_14442 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14442))
{var take_cb_14443 = cljs.core.async.impl.protocols.commit.call(null,taker_14442);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14443,taker_14442){
return (function (){return take_cb_14443.call(null,null);
});})(take_cb_14443,taker_14442))
);
} else
{}
{
